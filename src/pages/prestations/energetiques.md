...
propositions:
  ...
  - nom: "Massage du ventre CHI NEI TSANG"
    motsCles: ["Ventre", "Digestion", "Respiration"]
    text: "Pensé comme une véritable transformation de l'énergie, il favorise une libre circulation de la vitalité dans l'ensemble du corps. Par des pressions délicates et douces, il stimule vos grands systèmes métaboliques : digestif et lymphatique pour le drainage, nerveux pour apaiser l'esprit, immunitaire et vasculaire pour relancer la circulation. Une invitation au lâcher-prise."
    image: "/pictures/chiNeiTsang.jpg"
    alt: "Massage chi nei tsang du ventre"
    href: "/prestations/chiNeiTsang"
  - nom: "Massage convalescence®"
    motsCles: ["Sur mesure", "En douceur", "Zones sensibles"]
    text: "L'art de l'adaptation : chaque corps a son histoire. Ici, la main observe, ressent et s'adapte — aux douleurs, aux cicatrices, aux sensibilités. Elle sait distinguer une tension passagère d'une zone de protection réflexe. En levant les blocages sans forcer, ce massage favorise la capacité naturelle du corps à se réguler et à se régénérer."
    image: "/pictures/convalescence.jpg"
    alt: "Massage convalescence®"
    href: "/prestations/convalescence"
  - nom: "Shiatsu"
    motsCles: ["Reçu habillé", "Stress", "Sommeil"]
    text: "Reçu habillé, le shiatsu japonais travaille par pressions le long des méridiens. Il apaise le système nerveux, dénoue les tensions profondes et relance la libre circulation de l'énergie, sans jamais forcer."
